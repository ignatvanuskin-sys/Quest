 ...
 *
 * Должна быть БОЛЬШЕ длительности анимации Lenis (`duration: 1.4` в
 * LenisProvider), иначе проверка застаёт прокрутку в пути, видит расхождение
 * и запускает вторую анимацию поверх первой — цель останавливается мимо
 * (замер: секция отзывов вставала на 498 px вместо 72).
 */
const CORRECTION_DELAY_MS = 1700;
