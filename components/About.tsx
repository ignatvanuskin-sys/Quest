 ...
 */
/**
 * ПЛЕЙСХОЛДЕРЫ. Число комнат берётся из каталога, а «40+» и «16 000» —
 * демонстрационные значения, они подаются в интерфейсе как факты о бизнесе.
 * Перед продакшеном заменить на подтверждённые цифры клиента либо убрать
 * эти два блока: недостоверные сведения о собственной деятельности —
 * риск по ФЗ «О рекламе».
