...
const STEPS = [
  ...
  },
  {
    ...
    text: "Имя, телефон, дата и число игроков. Заявка сразу падает администратору в Telegram.",
    icon: (
  ...
  {
    n: "03",
    title: "Администратор свяжется с вами",
    text: "Подтвердит слот, ответит на вопросы и закрепит время за вашей группой.",
    icon: (
 ...
 * Оплаты на сайте нет намеренно: заявка уходит администратору в Telegram,
 * он связывается с гостем и закрепляет слот. Шаги описывают именно эту схему.
 */
